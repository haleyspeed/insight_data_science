...
achievement_list = pd.read_csv(os.path.join(config.clean_dir,
        'achievement_details_list.csv'))
...
dfo.to_csv(os.path.join(config.clean_dir,'achievement_details_trimmed.csv'))
